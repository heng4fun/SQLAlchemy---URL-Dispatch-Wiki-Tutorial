...
def view_wiki(request):
    """Display the wiki itself.It will answer on the root URL.
    
    """
    return HTTPFound(location=request.route_url('view_page',pagename='FrontPage'))  #HTTPFound is a redirect a URL.And route_url() API to construct a URL to the FrontPage page
    
@view_config(route_name='view_page', renderer='templates/view.pt',
             permission='view')
def view_page(request):
    """Display an indivisdual page.
...
def add_page(request):
    """Allows the users to add a page.
